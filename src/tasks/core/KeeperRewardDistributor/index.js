...
task("deploy:KeeperRewardDistributor", "Deploy KeeperRewardDistributor contract", require("./KeeperRewardDistributor.deploy"))
  ...
  .addParam("positionSizeCoefficientA", "The reward param which is needed to calculate rewards, in WAD")
  .addParam("positionSizeCoefficientB", "The reward param which is needed to calculate rewards")
