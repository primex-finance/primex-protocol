...
// This contract is the extended version of Uniswap's MixedRouteQuoterV1
// Origin: https://github.com/Uniswap/swap-router-contracts/blob/main/contracts/lens/MixedRouteQuoterV1.sol
// The contract has been modified to support Sushiswap: added method quoteExactInputSingleSushi, new factory and bitmask. 
...
import "@uniswap/swap-router-contracts/contracts/interfaces/IMixedRouteQuoterV1.sol";
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IUniswapV3SwapCallback, PeripheryImmutableState {
    ...
    address public immutable factorySushi;
    /// @dev Value to bit mask with path fee to determine if V2, Sushi or V3 route
    // max V3 fee:           000011110100001001000000 (24 bits)
    // mask:       1 << 23 = 100000000000000000000000 = decimal value 8388608
    // mask:       1 << 22 = 010000000000000000000000 = decimal value 4194304
    uint24 private constant flagBitmaskV2 = 8388608;
    uint24 private constant flagBitmaskSushi = 4194304;
    ...
    constructor(
        address _factory,
        address _factoryV2,
        address _factorySushi,
        address _WETH9
    ) PeripheryImmutableState(_factory, _WETH9) {
        factoryV2 = _factoryV2;
        factorySushi = _factorySushi;
    }
    ...
    function quoteExactInputSingleV2(
        ...
        amountOut = getPairAmountOut(params.amountIn, params.tokenIn, params.tokenOut, factoryV2);
    }

    /// @dev Fetch an exactIn quote for a sushiswap pair on chain
    function quoteExactInputSingleSushi(
        QuoteExactInputSingleV2Params memory params
    ) public view returns (uint256 amountOut) {
        amountOut = getPairAmountOut(params.amountIn, params.tokenIn, params.tokenOut, factorySushi);
    }
