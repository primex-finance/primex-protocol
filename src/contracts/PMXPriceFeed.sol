...
import {IPMXPriceFeed} from "./interfaces/IPMXPriceFeed.sol";

contract PMXPriceFeed is IPMXPriceFeed, AggregatorV2V3Interface {
    ...
    /**
     * @inheritdoc IPMXPriceFeed
     */
    function setAnswer(int256 answer) public override onlyRole(SMALL_TIMELOCK_ADMIN) {
