...
const TRADER_MAGIC_TIER = keccak256(toUtf8Bytes("TRADER_MAGIC_TIER"));
const LENDER_MAGIC_TIER = keccak256(toUtf8Bytes("LENDER_MAGIC_TIER"));
const FARMING_MAGIC_TIER = keccak256(toUtf8Bytes("FARMING_MAGIC_TIER"));
